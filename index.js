...
// ANSWER: so, instead of using for loop I could directly access the 4th element: 'let findFourth = numbers => numbers[3]' time complexity: O(1)
...
// ANSWER: Both functions have constant memory usage and it doesn't scale with the input size.
